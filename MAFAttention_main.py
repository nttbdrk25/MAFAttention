...
model_names = ['MAFCV1','MAFCV2','MAFCV3']
...
def main():
    ...
    if args.pretrained:
        ...
        if args.arch=="MAFCV1":
            model = build_mobilenet_v1(1000, width_multiplier=1, cifar=False,pool_types=['avg', 'std'])           
        if args.arch=="MAFCV2":
            model = build_mobilenet_v2(1000, width_multiplier=1, cifar=False,pool_types=['avg', 'std'])           
        if args.arch=="MAFCV3":                
            model = build_mobilenet_v3(1000, "large", width_multiplier=1, cifar=False,use_lightweight_head=False,pool_types=['avg', 'std'])                
